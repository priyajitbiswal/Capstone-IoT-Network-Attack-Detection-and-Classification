...
\title{Hierarchical Multi-Tier Network Intrusion Detection and Edge Latency Optimization on the CICIoT2023 Benchmark}

\author{\IEEEauthorblockN{Capstone Research Team}
\IEEEauthorblockA{\textit{Department of Computer Science \& Engineering} \\
\textit{Network Security and Machine Learning Laboratory}\\
Email: priyajitbiswal91@gmail.com}
}
